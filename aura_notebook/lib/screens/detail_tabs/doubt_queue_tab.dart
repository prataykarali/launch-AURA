...
class _DoubtQueueTabState extends State<DoubtQueueTab> {
  ...
  Future<void> _generateAnswer(_Doubt doubt) async {
    final prompt =
        'You are a ${widget.data.subject} teacher. A student asked: '
        '"${doubt.question}"\n\n'
        'Give a clear, helpful answer in 2–3 sentences. Be concise.';

    final buf = StringBuffer();
    try {
      // Assuming auraChat is your Rust FFI stream
            ...
            Expanded(
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: _hasText
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.help_outline_rounded, size: 18, color: d.accent.withOpacity(0.5)),
            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: _hasText
                      ? LinearGradient(colors: [d.color, d.accent], begin: Alignment.topLeft, end: Alignment.bottomRight)
                      : null,
                  color: !_hasText ? Colors.white.withOpacity(0.08) : null,
                ),
                child: Icon(Icons.send_rounded,
                    color: _hasText ? Colors.white : Colors.white.withOpacity(0.2),
                    size: 18),
              ),
            ),
          ]),
